...
Using ChatGPT to solve labeling issue with map

Lab 3: LINK

Finding and using various online resources to create and stylize dashboard appropriately

Using Mine's dashboard videos as references on creating my own dashboard
...
Adding an icon to the tab while it is open
